 ...
 */
time: number, } | { "op": "duplicateClips", 
/**
 * The clips to copy - normally the selection.
 */
clipIds: Array<string>, } | { "op": "freezeFrame", 
/**
 ...
 */
still?: NewMedia, } | { "op": "placeImageClips", 
/**
 * Ordered placements (media + start + duration).
 */
placements: Array<ImagePlacement>, 
/**
 ...
 */
clipId: string, } | { "op": "setClipSourceStart", 
/**
 * The clip to retime.
 */
clipId: string, 
